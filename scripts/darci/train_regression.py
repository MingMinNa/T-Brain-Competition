...
# 設定路徑
submission_path = os.path.join(const.SUBMISSION_FOLDER, "Submission", "upload.csv")
train_data_path = os.path.join(const.TRAINING_FOLDER, "TrainData", "total_train_data.csv")
incomplete_train_data_path = os.path.join(const.TRAINING_FOLDER, "TrainData", "incomplete_avg_train_data.csv")
output_model_path_rf = os.path.join(const.MODELS_FOLDER, "random_forest_model.pkl")
output_model_path_gb = os.path.join(const.MODELS_FOLDER, "gradient_boosting_model.pkl")
output_scaler_path = os.path.join(const.MODELS_FOLDER, "scaler.pkl")
output_csv_path = os.path.join(const.SUBMISSION_FOLDER, "Output", "regression_predictions.csv")
