...
output_lstm_module_path = os.path.join(const.MODELS_FOLDER, "lstm_model.h5")
output_regression_module_path = os.path.join(const.MODELS_FOLDER, "regression_model")
output_csv_path = os.path.join(const.SUBMISSION_FOLDER, "Output", "lstm.csv")
