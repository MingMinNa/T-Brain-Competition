...
train_data_path = os.path.join(project_root, "TrainData", "avg_train_data_closest_5d.csv")
submission_path = os.path.join(project_root, "Submission", "submission.csv")
output_module_dir = os.path.join(project_root, "Module")
output_ans_dir = os.path.join(project_root, "Output")
